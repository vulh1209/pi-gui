...
contextBridge.exposeInMainWorld("piApp", {
  ...
  setExtensionSurfaceField: (input: ExtensionSurfaceFieldUpdateInput) =>
    ipcRenderer.invoke(desktopIpc.setExtensionSurfaceField, input) as Promise<DesktopAppState>,
